        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DrawedNumbers = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DrawNumber", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DrawNumber_Draw_DrawId",
                        column: x => x.DrawId,
                        principalTable: "Draw",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WinningNums = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CombinationNumbers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CombinationNumbers_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CombinationNumbers_TicketId",
                table: "CombinationNumbers",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_DrawNumber_DrawId",
                table: "DrawNumber",
                column: "DrawId");
